...
const scanrateSelect = document.getElementById('scanrate'); // Fixed: Changed from 'rate' to 'scanrate'
...
function setupEventListeners() {
    ...
    // Standby radio event - THIS IS CRITICAL
    standbyRadio.addEventListener('change', function() {
        ...
        if (this.checked) {
            ...
            scanrateSelect.disabled = false;  // This enables the scan rate select
